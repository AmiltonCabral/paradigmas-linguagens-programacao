...
/* package StartingOut-0.1.0.0 */
#ifndef VERSION_StartingOut
#define VERSION_StartingOut "0.1.0.0"
#endif /* VERSION_StartingOut */
#ifndef MIN_VERSION_StartingOut
#define MIN_VERSION_StartingOut(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_StartingOut */
...
#define CURRENT_COMPONENT_ID "StartingOut-0.1.0.0-GMgM43nWhVJBWaMxxlLPw-StartingOut"
